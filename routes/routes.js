...
router.get(
  '/usuario/email/:email',
  UsuarioAuth,
  new UsuarioController().UsuarioByEmail
); // Usuário pelo email
...
router.post(
  '/mudarsenha/:token',
  UsuarioAuth,
  new UsuarioController().mudarSenha
); // Mudar senha
router.post(
  '/usuario/:id/:email',
  UsuarioAuth,
  new UsuarioController().DeletarMinhaContaEmail
); // Enviar email de deleção de conta
router.delete(
  '/deletarconta/:token',
  UsuarioAuth,
  new UsuarioController().DeletarMinhaConta
); // Deletar minha conta
router.delete(
  '/usuario/:id',
  AdminAuth,
  new UsuarioController().AdmDeletarUsuario
); // Adm deletar usuário
...
router.post(
  ...
  new ApontamentoController().criar
); // Criar apontamento
router.put(
  '/apontamento',
  AdminAuth,
  upload.single('miniatura'),
  new ApontamentoController().editar
); // Editar apontamento
router.delete(
  '/apontamento/:id',
  AdminAuth,
  new ApontamentoController().deletar
); // Deletar apontamento
